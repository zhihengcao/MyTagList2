...
- (void)setSelectedSegmentIndexes:(NSIndexSet *)selectedSegmentIndexes
{
    ...
    self.selectedIndexes = [[[NSMutableIndexSet alloc] initWithIndexSet:validIndexes] autorelease];
...
- (void)removeSegmentAtIndex:(NSUInteger)segment animated:(BOOL)animated
{
    ...
    NSMutableIndexSet *newSelectedIndexes = [[[NSMutableIndexSet alloc] initWithIndexSet:self.selectedIndexes] autorelease];
